...
public class RunnerChainLinkFactory {
    ...
    private Class<?> makeLinkClass(ClassPool pool, String newClassName, Class<? extends ParentRunner<?>> runnerClass,
        ...
        try {
            ...
            if (!isTestStructureProvider) {
                ...
                // for runners that aren't used to provide test structure, we make sure not to run validation
                newRunnerCtClass.addMethod(makeNullCollectInitializationErrorsMethod(newRunnerCtClass));
            }
    ...
    private AnnotationsAttribute makeAnnotationAttribute(ClassPool classPool, ConstPool pool, Annotation annotation) {
    ...
    private javassist.bytecode.annotation.Annotation makeBytecodeAnnotation(ClassPool classPool, ConstPool pool,
    ...
    private MemberValue makeMemberValue(ClassPool classPool, ConstPool pool, Object value) {
    ...
    private CtMethod makeNullCollectInitializationErrorsMethod(CtClass declaringClass) throws CannotCompileException {
        String collectInitializationErrors =
            "protected void collectInitializationErrors(java.util.List errors) { }";
        return CtNewMethod.make(collectInitializationErrors, declaringClass);
    }
